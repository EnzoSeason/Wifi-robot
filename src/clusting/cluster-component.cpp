...
#define NB_MAX_CLUSTERS 680
#define NB_MAX_POINTS 680
...
ClusterComponent::readScanFromInput(std::vector<vec2d>& points)
{
  ...
  {
  //  A compléter  
    points[i].x = distances->Integer32(i)*cos(angles->Float64(i)*3.1415926/180);
    points[i].y = distances->Integer32(i)*sin(angles->Float64(i)*3.1415926/180);
  }
}
